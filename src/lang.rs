...
const DEFAULTS: &[(&str, &str)] = &[
    ...
    ("drop_voted", "[{name}] voted to drop the lagging players ({votes}/{total})."),
    ("drop_by_vote", "The lagging players were dropped by vote."),
    ("drop_auto", "Lagging players were automatically dropped after waiting {seconds} seconds."),
    ("desync_state_group", "Players in game state {number}: {names}"),
    ("desync_dropped", "Dropped for desync: {names}"),
    ("desync_tie", "No majority game state, dropping all players."),
    ...
    ("download_usage", "Usage: !download <name>"),
    ("download_no_match", "No player matching [{name}] was found."),
    ("download_many_matches", "[{name}] matches more than one player; be more specific."),
    ("download_already_has_map", "{name} already has the map."),
    ("download_approved", "Map download approved for {name}."),
    ("download_game_started", "The game has already started."),
    ...
    ("autohost_status", "Autohost: {state} (name=[{name}], maxgames={maxgames}, startplayers={startplayers}); usage: !autohost on|off|<maxgames> <startplayers> [gamename]"),
    ("autohost_set", "Autohost updated (name=[{name}], maxgames={maxgames}, startplayers={startplayers})."),
    ("autohost_usage", "Usage: !autohost <maxgames> <startplayers> [gamename] (maxgames >= 1, startplayers 1-12, gamename <= 31 chars)"),
    ("state_on", "enabled"),
    ("state_off", "disabled"),
    ...
    ("map_search_none", "No map files found matching [{pattern}]."),
    ("map_search_multi", "Found {count} maps matching [{pattern}]: {list}"),
    ("map_loading", "Loading map [{file}]..."),
    ("map_loaded", "Map loaded: {file} (applies to newly hosted games)."),
    ("map_load_failed", "Failed to load map [{file}] (invalid or unreadable)."),
